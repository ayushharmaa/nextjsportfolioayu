...
export const Navbar = ()=> {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-10 bg-[#121212] bg-opacity-80"><div className="flex flex-wrap items-center justify-between mx-auto p-5 ">
        ...
        <ul className="flex p-4 md:p-0 md:p-0 md:flex-row md:space-x-8 mt-0">
            {
